...
bash register_MAD-Mex_rasters.sh /LUSTRE/MADMEX/products/landcover/landsat/2010/32/ madmex_lcc_landsat_2010_v4.3.1.tif Landsat7 32
...
bash create_downloadable_links_in_geonode.sh "National land cover map 2010 32 classes"
```